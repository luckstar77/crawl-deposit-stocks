...
const worker = async (SubjectData, isFutures) => {
  ...
  let parseDepositStocks = $('#example tbody tr').map((index, stock) => {
      return {
        ...
        dividendYield: parseFloat($(stock).children("td").eq(3).text()),
        s4eps: parseFloat($(stock).children("td").eq(4).text()),
        yeps: parseFloat($(stock).children("td").eq(5).text()),
        y1eps: parseFloat($(stock).children("td").eq(6).text()),
        y2eps: parseFloat($(stock).children("td").eq(7).text()),
        mRevenueYoY: parseFloat($(stock).children("td").eq(8).text()),
        m1RevenueYoY: parseFloat($(stock).children("td").eq(9).text()),
        m2RevenueYoY: parseFloat($(stock).children("td").eq(10).text()),
        mCumulativeRevenueYoY: parseFloat($(stock).children("td").eq(11).text()),
        s4opm: parseFloat($(stock).children("td").eq(12).text()),
        yopm: parseFloat($(stock).children("td").eq(13).text()),
        y1opm: parseFloat($(stock).children("td").eq(14).text()),
        y2opm: parseFloat($(stock).children("td").eq(15).text()),
        s4nim: parseFloat($(stock).children("td").eq(16).text()),
        ynim: parseFloat($(stock).children("td").eq(17).text()),
        y1nim: parseFloat($(stock).children("td").eq(18).text()),
        y2nim: parseFloat($(stock).children("td").eq(19).text()),
        cashM: parseFloat($(stock).children("td").eq(20).text()),
        qr: parseFloat($(stock).children("td").eq(21).text()),
      }
    }).get();
    ...
    parseDepositStocks = parseDepositStocks.reduce((accu, stock) => {
      ...
      let revenue = [stock.mRevenueYoY, stock.m1RevenueYoY, stock.m2RevenueYoY, stock.mCumulativeRevenueYoY];
